 ...
 * @author Shai Almog
 */
public class HelloWorldHexJavaCodenameOneStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "HelloWorldHexJavaCodenameOne";
    ...
    private HelloWorldHexJavaCodenameOne mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new HelloWorldHexJavaCodenameOneStub());
    }
        ...
        Display.getInstance().callSerially(new Runnable() {
            ...
            public void run() {
                if(Display.getInstance().isEdt()) {
                    mainApp = new HelloWorldHexJavaCodenameOne();
                    mainApp.init(this);
                    mainApp.start();
